...
int N=700; //numero di individui totali di tutti i continenti 200 per ogni continente, 10 continenti
int Ng=1000; //numero di generazioni
int Ng_migr=90; //numero di generazioni doopo cui migrare 
int N_migr=100;// numero di migranti
double p_cross=0.8; //70% probabilità di fare crossover
...
Population (int dim, vector<double> x, vector<double> y, Random& rnd);
Population (){ }
...
void average2(int i, int rank); // stampa media di L^2 ed errore sulla prima metà di popolazione
